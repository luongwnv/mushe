...
- [x] **Phase 1** — Google auth, lobby (create/join via RPCs), room shell.
- [ ] **Phase 2** — Realtime presence + clock-sync foundation.
- [ ] **Phase 3** — queue UI + voting (resolver `/search`, `/resolve`).
- [ ] **Phase 4** — YouTube IFrame player + both playback modes.
- [ ] **Phase 5** — edge cases (late join, host disconnect, ad recovery, polish).
